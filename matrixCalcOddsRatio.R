#!/usr/bin/R
# calculate the odds ratio and p-value for multiple exposure factors.
# the last row is the reference exposure
# the first colum is the case and second column is control

matrixCalcOddsRatio <- function(mymatrix,alpha=0.05,referencerow=3){
